      ...
      <div className="max-container">
        ...
        gap-20 flex-wrap max-lg:flex-col">
          ...
          items-start">
            ...
            <p className="text-base mt-6 font-montserrat leading-7
            text-white-400 sm:max-w-sm">Hitta dina perfekta nikeskor i en affär nära dig</p>
                  ...
                  <div key={section}>
                    ...
                    <ul>
                      {section.links.map((link) => (
                        <li className="text-white mt-3 font-montserrat
